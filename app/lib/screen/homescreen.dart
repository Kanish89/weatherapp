...
import 'package:myapp/screen/api.dart';
import 'package:myapp/screen/weathermodel.dart';
...
class _HomePageState extends State<HomePage> {
  ...
  Widget _buildWeatherWidget() {
    if (response == null) {
      ...
      return Container(
        color: const Color.fromARGB(255, 104, 194, 236),
        child: Column(
          ...
          children: [
            ...
            Card(
              elevation: 4,
              color: Color.fromARGB(255, 31, 1, 255),
              child: Column(
                children: [
                  Row(
